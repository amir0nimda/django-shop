    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.ManyToManyField(blank=True, to='product.Color', verbose_name='رنگ')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='مدیر')),
                ('visits', models.ManyToManyField(blank=True, related_name='product', to='product.IpAddress', verbose_name='تعداد بازدید ها')),
            ],
            options={
                'verbose_name': 'محصول',
